...
const ShopProducts = () => {
  ...
  const [products, setProducts] = useState([
    { id: 1, name: "Urea Fertilizer Gold", category: "Fertilizer", price: "266", stock: 50, unit: 'Bag', img: 'https://images.unsplash.com/photo-1628519592415-3135c34cb282?auto=format&fit=crop&w=100&q=80' },
    { id: 2, name: "Hybrid Tomato Seeds", category: "Seeds", price: "450", stock: 120, unit: 'Pkt', img: 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?auto=format&fit=crop&w=100&q=80' },
    { id: 3, name: "Neem Pesticide", category: "Pesticide", price: "180", stock: 5, unit: 'Bottle', img: 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?auto=format&fit=crop&w=100&q=80' },
    { id: 4, name: "Digging Spade", category: "Tools", price: "650", stock: 15, unit: 'Pc', img: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?auto=format&fit=crop&w=100&q=80' },
  ]);
  ...
  const handleSaveProduct = (e) => {
    ...
    // Set a dummy image if empty
    const imageToUse = formData.img || 'https://images.unsplash.com/photo-1530836369250-ef72a3f5cda8?auto=format&fit=crop&w=100&q=80';

    if (isEditing) {
      // Update existing
      setProducts(products.map((p) => (p.id === formData.id ? { ...formData, img: imageToUse } : p)));
    } else {
      // Add new
      const newProduct = { ...formData, id: Date.now(), img: imageToUse };
                  ...
                  <tr key={item.id} className="hover:bg-slate-50/80 transition-colors group">
                    <td className="p-5">
                      <div className="flex items-center gap-4">
                          <img src={item.img} alt={item.name} className="w-12 h-12 rounded-lg object-cover border border-slate-100" />
                          <div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
                ...
                <form onSubmit={handleSaveProduct} className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
                    ...
                    {/* Dummy Image Upload */}
                    <div className="border-2 border-dashed border-slate-300 rounded-xl p-6 flex flex-col items-center justify-center text-center hover:border-green-500 hover:bg-green-50/30 transition-all cursor-pointer group">
                        ...
                        <p className="text-xs text-slate-400 mt-1">SVG, PNG, JPG (Auto-generated for demo)</p>
                    </div>
