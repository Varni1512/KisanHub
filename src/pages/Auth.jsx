...
const Auth = () => {
  ...
  const roles = [
    ...
    { name: "Medicine Shopkeeper", route: "/shopkeeper" }
  ];

  const handleLogin = (e) => {
    e.preventDefault();
    // In a real app, you would fetch the user's role from your database here.
    // For now, we will simulate a redirect to a general dashboard or 
    // you can hardcode a role for testing purposes.
    console.log("Logging in... Fetching role from DB");
    navigate("/farmer"); // Defaulting to farmer for now
  };
            ...
            {isLogin ? (
              ...
              <motion.form key="login" variants={formVariants} initial="hidden" animate="visible" exit="exit" className="space-y-6" onSubmit={handleLogin}>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input required type="email" placeholder="example@mail.com" className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:border-green-500 outline-none transition-all" />
                  </div>
                </div>
              ...
              <motion.form key="signup" variants={formVariants} initial="hidden" animate="visible" exit="exit" className="space-y-4" onSubmit={handleSignup}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input required type="text" placeholder="Name" className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl outline-none" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-xs font-black uppercase tracking-widest text-slate-400 mb-2 ml-1">Email</label>
                    <div className="relative">
                      ...
                      <input required type="email" placeholder="Email" className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl outline-none" />
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select required className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl outline-none appearance-none cursor-pointer">
                ...
                <div className="relative">
                    ...
                    <input required type={showPass ? "text" : "password"} placeholder="Create Password" strokeWidth={18} className="w-full pl-11 pr-10 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl outline-none" />
